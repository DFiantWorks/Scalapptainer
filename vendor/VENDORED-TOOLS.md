...
| `cpio` | x86_64 | busybox 1.36.1-r31 (Alpine `busybox-static`) | [Alpine Linux](https://dl-cdn.alpinelinux.org/alpine/v3.20/main/) | **GPL-2.0-only** | `6d4ae568988ee24beb9dac4afdac4df67f90bbaed6ca47628da35ff5eb632a4c` |
| `cpio` | aarch64 | busybox 1.36.1-r31 (Alpine `busybox-static`) | Alpine Linux | **GPL-2.0-only** | `ebd2865edcab0b590c7d0edb70d3e782cbfb541e518a390ced3a3e186509bc7f` |

Notes:

- `cpio` is provided by a static **busybox** binary; busybox dispatches to its `cpio`
  applet when invoked as `cpio` (argv[0]). busybox is licensed **GPL-2.0-only** — its
  corresponding source is available from <https://www.busybox.net/> and the Alpine
