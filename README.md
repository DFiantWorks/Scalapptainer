...
```scala
//> using scala 3.3.8
//> using dep io.github.dfiantworks::scalapptainer:0.5.3
...
```scala
def mvnDeps = Seq(mvn"io.github.dfiantworks::scalapptainer:0.5.3")
```

sbt:

```scala
libraryDependencies += "io.github.dfiantworks" %% "scalapptainer" % "0.5.3"
```
