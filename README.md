...
```scala
//> using scala 3.3.8
//> using dep io.github.dfiantworks::scalapptainer:0.5.2
...
```scala
def mvnDeps = Seq(mvn"io.github.dfiantworks::scalapptainer:0.5.2")
```

sbt:

```scala
libraryDependencies += "io.github.dfiantworks" %% "scalapptainer" % "0.5.2"
```
